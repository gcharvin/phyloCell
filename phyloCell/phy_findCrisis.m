function [t1 t2 mid x y tdiv fdiv]=phy_findCrisis(tcells,cellindex,display)

dau=[tcells(cellindex).daughterList];
...
fdiv=[];
 ...
 tdiv=sort([tcells(dau).detectionFrame]);

    %timediv=tdiv;
    tdiv=tdiv(2:end)-tdiv(1:end-1);
    tdiv=tdiv(tdiv>0);
