...
for i=1:length(cellindex)
    ...
    %======================================================================================================================
    %======================================================================================================================
    fluo=fluo';  % modif 08/07/2013 pour faire maarcher la fonction sur le poste nord
    %======================================================================================================================
    %======================================================================================================================
    dfluo=-diff(fluo);
    ...
    peak=fpeak(1:1:length(dfluo),dfluo,10,[0 length(dfluo) 50 Inf]); % better function than matlab's fpeak
