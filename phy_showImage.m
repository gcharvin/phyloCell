...
imgout = insertShape(imgout,'FilledRectangle',[10 ROI(4)-20 prog(i)*(ROI(3)-20) 10],'Color', [254 205 131],'Opacity',1,'LineWidth',2);
...
imgout = insertShape(imgout,'FilledRectangle',[10      ROI(4)-20      prog(keyFrames(1))*(ROI(3)-20)       10],'Color', [254 205 131],'Opacity',1,'LineWidth',2);
imgout = insertShape(imgout,'FilledRectangle',[10+prog(keyFrames(1))*(ROI(3)-20)      ROI(4)-20     (prog(i)-prog(keyFrames(1)))*(ROI(3)-20)      10],'Color', [255 219 169],'Opacity',1,'LineWidth',2);
...
imgout = insertShape(imgout,'FilledRectangle',[10      ROI(4)-20    prog(keyFrames(1))*(ROI(3)-20) 10],'Color', [254 205 131],'Opacity',1,'LineWidth',2);
imgout = insertShape(imgout,'FilledRectangle',[10+prog(keyFrames(1))*(ROI(3)-20)       ROI(4)-20       (prog(keyFrames(2))-prog(keyFrames(1)))*(ROI(3)-20)       10],'Color', [255 219 169],'Opacity',1,'LineWidth',2);
imgout = insertShape(imgout,'FilledRectangle',[10+prog(keyFrames(2))*(ROI(3)-20)         ROI(4)-20         (prog(i)-prog(keyFrames(2)))*(ROI(3)-20)       10],'Color', [254 235 207],'Opacity',1,'LineWidth',2);
