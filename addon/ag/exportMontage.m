...
% Optional argument : cell cycle phase 'cycle', 1
% Example : 'cycle',1
...
for position = positions
    ...
    if noseg
    [segmentation timeLapse]=phy_openSegmentationProject(base,[project '-project.mat'],position,1);
    end
                ...
                for lk=1:length(contours(ik).channelGroup)
                   ...
                   %xc3,yc3,contours(ik)
                    ...
                    if cycle
                       ...
                       drawCycle(jim, xc3, yc3, java.awt.Color(contours(ik).color(1),contours(ik).color(2),contours(ik).color(3)), java.awt.Color(col1,col2,col3), java.awt.BasicStroke(width))
                    end
